...
{% macro risingwave__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro risingwave__check_schema_exists(information_schema,schema) -%}
...
{% macro risingwave__drop_schema(relation) -%}
...
{% macro risingwave__list_schemas(database) -%}
...
{% macro risingwave__rename_relation(from_relation, to_relation) -%}
...
{% macro risingwave__current_timestamp() -%}
